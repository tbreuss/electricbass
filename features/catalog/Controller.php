...
use app\features\catalog\models\Catalog;
use app\helpers\Url;
use Throwable;
use Yii;
...
final class Controller extends \yii\web\Controller
{
    public function actionAll(string $category): string
    {
        ...
        return $this->render('@app/features/catalog/views/all', [
    ...
    public function actionIndex(string $category, string $autor = '', string $publisher = '', string $series = ''): string
    {
        ...
        return $this->render('@app/features/catalog/views/index', [
    ...
    public function actionView($id, string $category): string
    {
        ...
        return $this->render('@app/features/catalog/views/view', [
            'title' => $this->getListTitle($category),
            'model' => $model,
    ...
    {
        $this->layout = 'onecol';
        return $this->render('@app/features/catalog/views/overview');
    }
