...
namespace app\features\alphaTab\components;

use app\features\alphaTab\models\AlphaDrums;
...
final class AlphaTabApi
{
    ...
    public function notation(): string
    {
        ...
        return implode(PHP_EOL, array_filter($lines)); // because of markdown issues
    }
