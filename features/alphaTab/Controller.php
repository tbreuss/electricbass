...
final class Controller extends \yii\web\Controller
{
    public function actionView(string $uid): string
    {
        ...
        $this->layout = 'empty';
        return $this->render('@app/features/alphaTab/views/view', [
    ...
    public function actionEditor(): string
    {
        ...
        return $this->render('@app/features/alphaTab/views/editor', [
    ...
    public function actionDebug(string $key = ''): string
    {
        ...
        return $this->render('@app/features/alphaTab/views/debug', [
            'models' => $models,
        ]);
    }
}
