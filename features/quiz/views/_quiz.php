...
<div class="quiz quiz--<?= $mode ?>">
    ...
    <div class="quiz-notes">
        <button class="quiz-notes-button" value="c:">c</button>
        <button class="quiz-notes-button" value="d:">d</button>
        <button class="quiz-notes-button" value="e:">e</button>
        ...
        <button class="quiz-notes-button" value="h:" disabled="">h</button>
    </div>
    <?php endif ?>
</div>
