...
/**
 * @var app\features\advertisement\models\Advertisement[] $models
...
<div class="content">
    ...
    <?php foreach ($models as $model): ?>
        <?php if (!array_key_exists($model->category_id, $categories)): ?>
            <?php $categories[$model->category_id] = ['title' => app\features\advertisement\models\Advertisement::$categories[$model->category_id]]; ?>
