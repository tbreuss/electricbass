...
/**
 * @var app\features\advertisement\models\Advertisement $advertisement
 * @var app\features\advertisement\models\AdvertisementContactForm $model
...
<div class="content">
    ...
    <div class="col-sm-10 form__row">
        ...
        <?= Captcha::widget(['captchaAction' => ['/advertisement/captcha'], 'name' => 'AdvertisementContactForm[verifyCode]', 'options' => ['class' => 'form__textInput ' . $errorClass]]) ?>
