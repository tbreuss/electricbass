...
/**
 * @var app\features\album\models\Album $model
...
<div class="content">
    ...
    <?php if (!empty($model->artist)): ?>
        <p style="margin-bottom: 1.5rem">von <?= Html::a($model->artist, ['album/index', '#' => 'artist=' .urlencode($model->artist)]) ?></p>
    <?php endif; ?>
...
<?= app\features\comment\Widget::widget(["tableName" => "album", "tableId" => $model->id]) ?>
