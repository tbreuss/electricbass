...
$config = [
    ...
    'controllerMap' => [
        ...
        'glossary' => app\features\glossary\Controller::class,
    ...
    'components' => [
        ...
        'shortcode' => [
            ...
            'tags' => [
                'alphatab' => ['app\features\widgets\Parser', 'alphatab'],
                'amazon' => ['app\features\widgets\Parser', 'amazon'],
                'articles' => ['app\features\widgets\Parser', 'articles'],
                'downloads' => ['app\features\widgets\Parser', 'downloads'],
                'htmlphp' => ['app\features\widgets\Parser', 'htmlphp'],
                'img' => ['app\features\widgets\Parser', 'image'],
                'imgtext' => ['app\features\widgets\Parser', 'imgtext'],
                'links' => ['app\features\links\Shortcode', 'render'],
                'jsongallery' => ['app\features\widgets\Parser', 'jsongallery'],
                'jsonlinks' => ['app\features\widgets\Parser', 'jsonlinks'],
                'lessonnav' => ['app\features\widgets\Parser', 'lessonnav'],
                'rssfeed' => ['app\features\widgets\Parser', 'rssfeed'],
                'score' => ['app\features\widgets\Parser', 'score'],
                'soundcloud' => ['app\features\widgets\Parser', 'soundcloud'],
                'spotify' => ['app\features\widgets\Parser', 'spotify'],
                'vimeo' => ['app\features\widgets\Parser', 'vimeo'],
                'websites' => ['app\features\widgets\Parser', 'websites'],
                'youtube' => ['app\features\widgets\Parser', 'youtube'],
                'play-along' => ['app\features\widgets\Parser', 'playAlong'],
